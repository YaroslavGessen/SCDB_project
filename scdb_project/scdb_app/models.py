...
class Spectrum(Data):
    ...
    molecule = models.OneToOneField(Molecule, related_name='spectrum', on_delete=models.CASCADE)
    article = models.ForeignKey(Article, related_name='spectra', on_delete=models.CASCADE)
...
class Performance(Data):
    ...
    molecule = models.ForeignKey(Molecule, related_name='performances', on_delete=models.CASCADE)
...
class Contribution(Data):
    ...
    def get_absolute_url(self):
        return reverse("single-evaluation", kwargs={'short_id': self.short_id})
